...
declare class CalendarProvider extends Component<Props> {
    ...
    style: {
        ...
        knobContainer: {
            position: "absolute";
            left: number;
            right: number; /** Today button's style */
            height: number;
            bottom: number;
            alignItems: "center"; /** The opacity for the disabled today button (0-1) */
        ...
        headerTitle: {
            alignSelf: "center";
            paddingTop: number; /** Whether to show the today button */
            paddingBottom: number;
            fontSize: number;
            fontFamily: string;
    ...
    getProviderContextValue: () => {
        setDate: (date: Date | string, updateSource: UpdateSource) => void;
        date: Date;
        prevDate: Date;
        updateSource: any;
